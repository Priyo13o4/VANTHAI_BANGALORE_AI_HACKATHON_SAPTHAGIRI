...
export const API_ENDPOINTS = {
  PATIENT: import.meta.env.VITE_PATIENT_API_URL || 'http://localhost:8001',
  DOCTOR: import.meta.env.VITE_DOCTOR_API_URL || 'http://localhost:8002',
  HOSPITAL: import.meta.env.VITE_HOSPITAL_API_URL || 'http://localhost:8003',
  EMERGENCY: import.meta.env.VITE_EMERGENCY_API_URL || 'http://localhost:8004',
  WEARABLES: import.meta.env.VITE_WEARABLES_API_URL || 'http://localhost:8005',
} as const;
