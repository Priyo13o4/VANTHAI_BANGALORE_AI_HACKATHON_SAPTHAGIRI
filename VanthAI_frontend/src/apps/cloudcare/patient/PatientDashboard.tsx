...
import { FALLBACK_PATIENT_ID, getPatientById, type PatientSnapshot } from '../data/mockData';
import { formatDate, formatRelativeTime } from '../data/formatters';
        ...
        <Card sx={{ borderRadius: 3 }}>
          <CardContent>
            ...
            {loading ? (
              ...
              <Box sx={{ display: 'flex', flexDirection: 'column', gap: 1.5 }} data-vanthai-id="cloudcare-records-latest">
