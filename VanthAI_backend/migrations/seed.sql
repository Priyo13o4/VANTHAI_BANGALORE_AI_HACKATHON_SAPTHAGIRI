...
INSERT INTO health_records (id, patient_id, record_type, description, diagnosis, treatment, doctor_id, hospital, record_date) VALUES
  (101, 1, 'Consultation', 'Cardiology review — systolic BP averaged 145 mmHg',
   'Hypertension not fully controlled',
   'Continue Amlodipine 5mg daily, add evening walk regimen',
   1, 'City General Hospital', '2025-10-15 10:00'),
  (102, 1, 'Lab Test', 'Complete lipid profile and HbA1c screening',
   'LDL 145 mg/dL — HbA1c 7.2%',
   'Maintain Metformin, start Atorvastatin 10mg nightly',
   2, 'City General Hospital', '2025-10-10 08:30'),
  (103, 1, 'Emergency', 'Emergency visit for chest discomfort and dizziness',
   'Ruled out myocardial infarction; observed anxiety episode',
   'Observation 4 hours, prescribed short-term anxiolytic',
